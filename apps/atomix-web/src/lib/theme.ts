...
export const phaseBackgroundColors = {
  ...
  [ElementPhase.ExpectedGas]:
    'bg-gradient-to-b from-zinc-800/50 via-40% via-zinc-800/50 to-green-800/50',
  [ElementPhase.ExpectedLiquid]: '',
  [ElementPhase.ExpectedSolid]:
    'bg-gradient-to-b from-zinc-800/50 via-40% via-zinc-800/50 to-neutral-600/50'
};
